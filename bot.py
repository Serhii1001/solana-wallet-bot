...
PERSONAS = {
    ...
    111111112: {
        "names": ["Бодя", "Негр", "Пёс", "Индюк черножопый"],
        "style": "колкости + мат,  добавить какие то гейские шутки про него, максимально жестко оскорблять"
    },
    617500468: {
...
async def handle_msg(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    system_prompt = (
        ...
        f"Скажи грубо, унизительно, язвительно. Используй блатной жаргон, понты, уличную лексику. "
